...
import type { parseDataType } from "./PostContainerComponsnts/CommentComp/CommentAddation"
...
const InputWithAndHastags = ({
  ...
  const renderHsetagsSuggestion = (
    ...
    return (
      ...
      >
        <div className="flex-shrink-0">{/* No profile picture for hashtags */}</div>
    ...
    return (
      ...
      >
        <div className="flex-shrink-0">
          ...
          suggestion.profile?.profilePicture.find((img) => img.type === "profile") ? (
            <Image
