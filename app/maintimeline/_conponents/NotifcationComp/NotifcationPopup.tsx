...
import { mentionType, NotificationType, User } from "@prisma/client";
...
import { useGetNotifcationQuery } from "@/store/api/apiNotifcation";
...
function getNotificationColors(notificationType: NotificationType): {
  ...
  const colors: Record<NotificationType, { flatColor: string; textColor: string }> = {
    [NotificationType.MENTION]: { flatColor: "#00a3e473", textColor: "#FFFFFF" },
    [NotificationType.LIKE]: { flatColor: "#ff562257", textColor: "#FFFFFF" },
    [NotificationType.COMMENT]: { flatColor: "#4caf4f60", textColor: "#FFFFFF" },
    [NotificationType.REPLAY_IN_REPLAY]: { flatColor: "#3F51B5", textColor: "#FFFFFF" },
    [NotificationType.FOLLOW]: { flatColor: "#FF9800", textColor: "#FFFFFF" },
    [NotificationType.FOLLOW_BACK]: { flatColor: "#8BC34A", textColor: "#FFFFFF" },
    ...
    [NotificationType.MENTION_POST]: { flatColor: "#e91e6242", textColor: "#FFFFFF" },
    [NotificationType.MENTION_COMMENT]: { flatColor: "#FF5722", textColor: "#FFFFFF" },
    [NotificationType.MENTION_REPLAY]: { flatColor: "#00A4E4", textColor: "#FFFFFF" },
    [NotificationType.POST_REACT]: { flatColor: "#3F51B5", textColor: "#FFFFFF" },
    [NotificationType.COMMENT_REACT_AUTHOR]: { flatColor: "#9b27b058", textColor: "#FFFFFF" },
    [NotificationType.COMMENT_REACT_COMMENTER]: { flatColor: "#9b27b058", textColor: "#FFFFFF" },
    [NotificationType.REPLY_REACT_AUTHOR]: { flatColor: "#ffc1075a", textColor: "#000000" },
    [NotificationType.REPLY_REACT_COMMENTER]: { flatColor: "#ffc1075a", textColor: "#000000" },
    COMMENT_REACT: {
      flatColor: "",
      textColor: ""
    },
...
const NotifcationPopup = ({ user }: { user: User }) => {
  const {
    data: Notifcations,
    isLoading,
    isFetching,
