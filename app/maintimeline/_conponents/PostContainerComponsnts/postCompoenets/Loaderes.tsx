  ...
  return (
    <div className="bg-white rounded-xl p-4 sticky top-0 h-1/6 w-full shadow-md">
      <div className="flex justify-between items-center gap-3 w-full">
        ...
        />
        <Skeleton
          className="w-4/6 sm:w-5/6 bg-gray-300 h-9"
          />
...
export const HeaderPostLoader = () => {
    return (
      <div className=' w-full flex justify-start items-center gap-3'>
        <Skeleton
        className='w-12 rounded-full h-12 bg-gray-300 '
        />
        <div
        className='flex w-full justify-start items-start gap-2 flex-col'
        >
...
export const InteractionsLoader = () => {
    return (
      <div
      className=' flex mt-3 justify-start items-center gap-3 w-full'
      >
        <Skeleton
        className='w-3/12 h-6 bg-gray-300'
        />
  ...
  export const InteractionButtonsLoader= () => {
    return (
      <div className='flex justify-start items-center gap-3 mt-3 w-full'>
        <Skeleton
        className='w-1/4 h-9 bg-gray-300'
        />
        <Skeleton
        className='w-1/4 h-9 bg-gray-300'
        />
