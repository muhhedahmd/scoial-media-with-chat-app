...
import { Clipboard, Edit, Pin, EllipsisVertical } from "lucide-react"
    ...
    <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
      ...
      <PopoverContent className="w-56">
        <div className="grid gap-4">
          <Button variant="ghost" className="w-full justify-start" onClick={copyPostLink}>
            <Clipboard className="mr-2 h-4 w-4" />
            Copy Post link
          </Button>
          {mainUserId === authorId && (
            <>
              <DeleteDialog mainUserId={mainUserId} postId={postId} setIsPopoverOpen={setIsPopoverOpen} />
              <Button variant="ghost" className="w-full justify-start" onClick={() => setIsEditDialogOpen(true)}>
