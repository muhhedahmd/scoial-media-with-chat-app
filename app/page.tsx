      ...
      <main className="bg-gray-900 text-white min-h-screen flex flex-col">
        ...
        <section className="flex-grow flex items-center justify-center text-center px-6">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              ...
              <span className="text-blue-600">SocialApp</span>.
            </h1>
            <p className="text-lg mb-8 text-gray-400">
              Share {"what's"} on your mind, discover new people, and stay
              updated on your {"friends'"} activities.
            </p>
            <Link
              href="/signup"
              className="px-6 py-3 bg-blue-600 rounded text-lg hover:bg-blue-500"
            >
              Get Started
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 px-6 max-w-6xl mx-auto">
            ...
            <div className="bg-gray-700 p-6 rounded-lg">
              ...
              <p className="text-gray-400">
                Post photos, updates, and stories. Let your friends know what’s
            ...
            <div className="bg-gray-700 p-6 rounded-lg">
              ...
              <p className="text-gray-400">
                Stay up to date with your {"friends'"} posts and activities with
                our easy-to-use feed.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-blue-600 py-16 text-center">
          ...
          <p className="text-lg mb-8 text-gray-100">
            Sign up now and start connecting with friends.
          </p>
          <Link
            href="/signup"
            className="px-8 py-4 bg-gray-900 rounded text-white text-lg hover:bg-gray-800"
          >
            Create Your Account
          </Link>
        </section>
